...
X_test = np.hstack((X2_test, X_extra_test, X_test_1234, X_test_1234_2, X_test_1234_3, X_test_union_f, X_test_anti_1234))
...
cv_generate(b, "ann10b", X, y, X_test, generate_test=True, xempty=None)
